...
//payment
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jTable1.getRowCount() == 0) {
            ...
            MySQL.iud("INSERT INTO `grn` (`date_time`,`supplier_id`,`user_id`,`unique_id`) VALUES ('" + dNow + "','" + sid + "','" + Signin.userId + "','" + uniqueId + "')");
            //GRN INSERT
            try {
                ...
                MySQL.iud("INSERT INTO `grn_payment`(`payment`,`balance`,`grn_id`,`payment_type_id`) VALUES ('" + payment + "','" + balance + "','" + gid + "','" + paymentTypeId + "')");

                //GRn payment insert
//GRN item INSERT & Stock INSERT or UPDATE
                InputStream stream = getClass().getResourceAsStream("/reports/HardwareGRN.jrxml");
                ...
                String suppliername = jLabel4.getText();
                String contactnumber = jLabel6.getText();
                String branchname = jLabel8.getText();
                ...
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    ...
                    ResultSet rs3 = MySQL.search("SELECT * FROM `stock` WHERE `product_id` = '" + pid + "' AND `selling_price` = '" + sellingprice + "' AND `mfd` = '" + mfd + "' AND `exd` = '" + exd + "'");
                    {
                        ...
                        if (rs3.next()) {
                            ...
                            MySQL.iud("INSERT INTO `stock` (`product_id`,`quantity`,`selling_price`,`mfd`,`exd`,`measurement_id`) VALUES ('" + pid + "','" + qty + "','" + sellingprice + "','" + mfd + "','" + exd + "','" + measurementid + "')");
                        ...
                        MySQL.iud("INSERT INTO `grn_item`(`quantity`,`buying_price`,`stock_id`,`grn_id`) VALUES ('" + qty + "','" + buyingprice + "','" + stock_id + "','" + gid + "')");
                    }

                    //v.add(new Bean_GRN(pid,category,bnd,nm,qty,measurement,buyingprice,sellingprice,mfd,exd,to));
